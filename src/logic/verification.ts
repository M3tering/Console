...
// Transaction data structure for verification
...
export function chooseVerifierNode(nodes: VerifierNode[]): VerifierNode | null {
  try {
    ...
    console.log("🎯 Selected verifier node:", { id: selectedNode.id, url: selectedNode.url });
    return selectedNode;
  } catch (err: any) {
...
export async function sendTransactionsToVerifier(
  transactions: TransactionForVerification[],
